...
import com.esdsquad.piknik.databinding.FragmentNimbrungBinding

class NimbrungFragment : Fragment() {

    private lateinit var binding: FragmentNimbrungBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentNimbrungBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupView() {
        binding.tvLayoutToolbar.tvToolbar.text = "Nimbrung"
